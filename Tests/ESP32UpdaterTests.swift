...
final class ESP32UpdaterTests: XCTestCase {
    ...
    func testC5InstallerManifestProducesOfficialThreeFilePackageWithNormalApplication() throws {
        ...
        XCTAssertEqual(
            ...
            [
                "esp32_marauder_installer_v1_14_1_20260801_esp32c5devkitc1.bootloader.bin",
    ...
    func testC5InstallerManifestFailsClosedOnRequiredAssetDigestMismatch() throws {
        let manifest = try ESP32Updater.decodeManifest(c5ManifestData(), expectedVersion: "v1.14.1")
        let bootloader = "esp32_marauder_installer_v1_14_1_20260801_esp32c5devkitc1.bootloader.bin"
        var digests = c5ReleaseAssetSHA256
        digests[bootloader] = String(repeating: "d", count: 64)
        ...
        XCTAssertThrowsError(try ESP32Updater.factorySegments(
            ...
            assetSHA256: digests)) { error in
                XCTAssertEqual(error as? ESP32ManifestError, .assetMetadataMismatch(bootloader))
            }
    }
        ...
        Data(#"""
        {
          ...
          "targets": [{
            ...
            "flash": {"factory": {"segments": [
              ...
              {"role":"partition-table","offset":32768,"size":3072,"sha256":"0a8b5720e7b77ff11f1462458c3a509dee79224e5279898f26d6a2e3ae0517b7","fileName":"esp32_marauder_installer_v1_14_1_20260801_esp32c5devkitc1.partition-table.bin"},
    ...
    private var c5ReleaseAssetSHA256: [String: String] {
        [
            "esp32_marauder_installer_v1_14_1_20260801_esp32c5devkitc1.bootloader.bin":
                "f0cc3970dbf6001eb398e589244047f0731acbc0ded1ccfa952cd7559c083b13",
            "esp32_marauder_installer_v1_14_1_20260801_esp32c5devkitc1.partition-table.bin":
